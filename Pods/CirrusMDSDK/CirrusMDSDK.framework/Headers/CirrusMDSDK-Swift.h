...
SWIFT_CLASS("_TtC11CirrusMDSDK17CirrusMDSDKConfig")
@interface CirrusMDSDKConfig : NSObject
...
- (void)setConfig:(CirrusMDSDKConfig * _Nonnull)config;
...
typedef SWIFT_ENUM(NSInteger, CirrusMDSDKSessionResult, closed) {
...
typedef SWIFT_ENUM(NSInteger, CirrusMDSKSessionTokenState, closed) {

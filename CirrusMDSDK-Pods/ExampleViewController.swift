...
class ExampleViewController: UIViewController {
    ...
    @IBOutlet weak var getSDKTokenButton: UIButton!
    ...
    @IBAction func getSDKTokenTapped(_ sender: Any) {
    ...
    override func viewDidLoad() {
        ...
        getSDKTokenButton.setTitle("Get Token for SDK", for: .normal)
        getSDKTokenButton.isEnabled = true
